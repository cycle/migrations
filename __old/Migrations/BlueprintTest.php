...
abstract class BlueprintTest extends BaseTest
{
    ...
    {
        $blueprint = new TableBlueprint(new Capsule($this->dbal), 'sample');
    ...
    {
        $blueprint = new TableBlueprint($capsule = new Capsule($this->dbal), 'sample');
    ...
    {
        $blueprint = new TableBlueprint($capsule = new Capsule($this->dbal), 'sample1');
    ...
    /**
     * @expectedException \Spiral\Migrations\Exceptions\Operation\ColumnException
     */
    ...
    /**
     * @expectedException \Spiral\Migrations\Exceptions\Operation\IndexException
     */
